...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var delete_single_num = document.querySelector('#delete_single_num');
  var Normal_btn = document.querySelectorAll('#Normal_btn');
  var equationArray = [];
  var initial_value = "";
  Normal_btn.forEach(function (Normal_btn, index) {
    Normal_btn.addEventListener('click', function () {
      ...
      if (this.dataset.type === "operation" && equationArray[equationArray.length - 1].type === "operation") {
        ...
        result.innerHTML = equationArray.map(function (item) {
          return item.value;
        }).join(' ');
      }
    });
